...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Luxury beauty: skincare, makeup, haircare and fragrance. Vegan, cruelty-free, dermatologist tested. Get to know about our products & share your feedbacks" },
      { name: "author", content: "Lumière Beauty" },
      { property: "og:title", content: "Lumière Beauty — Luxury Beauty, Consciously Crafted" },
      { property: "og:description", content: "Luxury beauty: skincare, makeup, haircare and fragrance. Vegan, cruelty-free, dermatologist tested. Get to know about our products & share your feedbacks" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Lumière Beauty — Luxury Beauty, Consciously Crafted" },
      { name: "twitter:description", content: "Luxury beauty: skincare, makeup, haircare and fragrance. Vegan, cruelty-free, dermatologist tested. Get to know about our products & share your feedbacks" },
